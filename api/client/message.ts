...
export function useGetAllMessagesByUser(user) {
...
export function useGetAllMsgByReceiptant(params = {}) {
    ...
    const queryKey = [API_ROUTE.messages.getMessageByUserWithRecipitant, params]
    const {
        data,
        status,
        error,
        ...
        queryKey,
        enabled: !!params.userId && !!params.recipientId,
        queryFn: ({ pageParam }) =>
            api.get(
