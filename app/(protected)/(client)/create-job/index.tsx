    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.row}>
          <View style={styles.halfWidth}>
            ...
            />
            {errors.minSalaray && (
              <Text style={styles.error}>{errors.minSalaray.message}</Text>
            )}
          </View>
          ...
          <View style={styles.halfWidth}>
            ...
            />
            {errors.maxSalaray && (
              <Text style={styles.error}>{errors.maxSalaray.message}</Text>
            )}
          </View>
        </View>
      </View>
      ...
      <View style={styles.card}>
        ...
        {errors.jobDescription && (
          <Text style={styles.error}>{errors.jobDescription.message}</Text>
        )}
      </View>
      ...
      <View style={styles.card}>
        ...
        {errors.totalPersontoHire && (
          <Text style={styles.error}>{errors.totalPersontoHire.message}</Text>
        )}
      </View>
