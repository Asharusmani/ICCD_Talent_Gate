...
// import ModernLoader from '@/components/ui/loader2'
...
export default function OrderScreen() {
  ...
  const { data, totalPages, isError, error, isLoading } = useGetOrderByClient();
  
  // if (true) return <ICCDLoader />
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.listContainer}>
        <FlatList
          ...
          contentContainerStyle={{ gap: 15, paddingBottom: 160 }}
